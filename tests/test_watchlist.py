...
def test_get_watchlist_returns_newest_first(app, sample_user):
    ...
    (most recently added first), matching get_collection(). The titles are
    chosen so alphabetical order would be the reverse — this fails under the
    old Film.title ordering and only passes with date_added ordering.
    """
    with app.app_context():
